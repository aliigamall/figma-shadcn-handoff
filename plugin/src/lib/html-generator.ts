...
// ─── Layout helpers (mirrors jsx-generator) ───────────────────────────────────
...
type Layout = { direction: "none" | "horizontal" | "vertical"; wrap: boolean; gap: number; paddingTop: number; paddingRight: number; paddingBottom: number; paddingLeft: number; };

function paddingClasses(layout: Layout): string {
...
function layoutClasses(layout: Layout): string {
